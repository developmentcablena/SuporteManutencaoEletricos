...
'        MsgBox "Digite a senha atual!", vbOKOnly + vbExclamation, "Suporte Manutenção"
'        txtSenhaAtual.SetFocus
'        Exit Sub
'    End If
    
    If Len(Trim(txtNovaSenha.Text)) = 0 Then
        MsgBox "Digite uma nova senha!", vbOKOnly + vbExclamation, "Suporte Manutenção"
    ...
    If CodDec(Trim(txtSenhaAtual.Text)) <> gstrSenha Then
        MsgBox "Senha atual não confere!", vbOKOnly + vbCritical, "Suporte Manutenção"
        txtSenhaAtual.Text = ""
        txtSenhaAtual.SetFocus
        Exit Sub
    End If
    ...
    If Trim(txtNovaSenha.Text) <> Trim(txtConfirmar.Text) Then
        MsgBox "Nova senha diferente da confirmação!", vbOKOnly + vbExclamation, "Suporte Manutenção"
        txtNovaSenha.Text = ""
        txtConfirmar.Text = ""
        txtNovaSenha.SetFocus
        Exit Sub
...
On Error GoTo Erro
    ...
    MsgBox "Senha alterada com sucesso!", vbOKOnly + vbInformation, "Suporte Manutenção"
    Set rs = Nothing
    Call Unload(Me)
