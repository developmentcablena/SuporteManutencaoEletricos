...
Private Sub cmdValidar_Click()
    If Len(Trim(txtUsuario.Text)) = 0 Then
        MsgBox "Digite o usuário!", vbOKOnly + vbExclamation, "Suporte Manutenção"
        txtUsuario.SetFocus
        Exit Sub
    End If
    
'    If Len(Trim(txtSenha.Text)) = 0 Then
'        MsgBox "Digite a senha!", vbOKOnly + vbExclamation, "Suporte Manutenção"
'        txtSenha.SetFocus
'        Exit Sub
'    End If
    ...
    Else
        MsgBox "Usuário ou senha inválida!", vbOKOnly + vbCritical, "Suporte Manutenção"
        txtUsuario.Text = ""
        txtSenha.Text = ""
        txtUsuario.SetFocus
    End If
