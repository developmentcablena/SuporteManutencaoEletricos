...
Begin VB.Form frmUsuarios 
   ...
   Caption         =   "Suporte Manutenção - Usuários"
   ClientHeight    =   5745
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   7575
...
Private Sub cmdEditar_Click()
    ...
    Else
        MsgBox "Nenhum usuário foi selecionado!", vbOKOnly + vbExclamation, "Suporte Manutenção"
        cmdNovo.Enabled = True
        cmdSalvar.Caption = "&Salvar"
    End If
End Sub
...
Private Sub cmdSalvar_Click()
    If Len(Trim(txtNome.Text)) = 0 Then
        MsgBox "Digite o nome do usuário!", vbOKOnly + vbExclamation, "Suporte Manutenção"
        txtNome.SetFocus
        Exit Sub
    End If
    
    If Len(Trim(txtUsuario.Text)) = 0 Then
        MsgBox "Digite o login do usuário!", vbOKOnly + vbExclamation, "Suporte Manutenção"
        txtUsuario.SetFocus
        Exit Sub
    End If
    
    If Len(Trim(txtDepto.Text)) = 0 Then
        MsgBox "Digite o departamento do usuário!", vbOKOnly + vbExclamation, "Suporte Manutenção"
        txtDepto.SetFocus
        Exit Sub
    End If
    ...
    If chkEmBranco.Value = 0 Then
        If Len(Trim(txtSenha.Text)) = 0 Then
            MsgBox "Digite uma senha!", vbOKOnly + vbExclamation, "Suporte Manutenção"
            txtSenha.SetFocus
            Exit Sub
        End If
        
        If Len(Trim(txtConfirmar.Text)) = 0 Then
            MsgBox "Digite a confirmação da senha!", vbOKOnly + vbExclamation, "Suporte Manutenção"
    ...
    If Trim(txtSenha.Text) <> Trim(txtConfirmar.Text) Then
        MsgBox "Senhas não conferem!", vbOKOnly + vbExclamation, "Suporte Manutenção"
        txtSenha.Text = ""
        txtConfirmar.Text = ""
        txtSenha.SetFocus
        Exit Sub
    Else
        If cmdSalvar.Caption = "&Salvar" Then
            If fnCadastrarUsuario(Trim(txtNome.Text), Trim(txtUsuario.Text), CodDec(Trim(txtSenha.Text)), Trim(txtDepto.Text), Trim(txtEMail.Text), chkInativo, chkAlterar) = True Then
                MsgBox "Usuário cadastrado com sucesso!", vbOKOnly + vbInformation, "Suporte Manutenção"
